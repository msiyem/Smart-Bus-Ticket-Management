-- ============================================================
-- Smart Bus Ticket Management System - Initial Migration
-- Run: mysql -u root -p database_name < 2026_07_10_000001_initial_schema.sql
-- ============================================================
...
-- ============================================================
-- 002: (removed - refresh tokens are no longer used)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS `routes` (
  ...
  `updated_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    ON UPDATE CURRENT_TIMESTAMP,
  KEY `idx_routes_source` (`source_city`),
  KEY `idx_routes_destination` (`destination_city`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- ============================================================
-- 005: BUSES (operator_id is added later via idempotent ALTER)
-- ============================================================
...
-- ============================================================
-- 007: BUSES - add operator_id (idempotent)
-- ============================================================
SET @col_exists := (
...
-- ============================================================
-- 011: TRIPS (materialized instances of a schedule for a date)
-- ============================================================
